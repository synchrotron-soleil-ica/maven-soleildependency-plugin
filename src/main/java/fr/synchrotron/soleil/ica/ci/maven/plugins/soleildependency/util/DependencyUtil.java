package fr.synchrotron.soleil.ica.ci.maven.plugins.soleildependency.util;
...
public final class DependencyUtil {
     ...
     * @param useRepositoryLayout  if dependendies must be moved into a Maven repository layout, if
