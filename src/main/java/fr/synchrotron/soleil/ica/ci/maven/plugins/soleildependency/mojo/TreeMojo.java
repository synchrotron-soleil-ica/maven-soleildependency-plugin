package fr.synchrotron.soleil.ica.ci.maven.plugins.soleildependency.mojo;
...
import fr.synchrotron.soleil.ica.ci.maven.plugins.soleildependency.util.DependencyUtil;
 ...
 * @author Gregory Boissinot Add metadata retriever
...
public class TreeMojo extends AbstractMojo {
    ...
    private DependencyNode addAndModifyPubDateDependencyTreeWithLog(MetadataRetrieverService metadataRetrieverService,
                                                                    Writer writer,
                                                                    DependencyNode rootNode) {

        DependencyNodeTreeReplacerService dependencyNodeTreeReplacer =
                new DependencyNodeTreeReplacerService(new ArtifactCustomCreatorService(metadataRetrieverService));
        return dependencyNodeTreeReplacer.replaceDependencyNode(writer, rootNode);
    }
